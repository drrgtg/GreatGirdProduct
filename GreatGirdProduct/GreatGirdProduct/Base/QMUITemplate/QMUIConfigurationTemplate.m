...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarTintColor = [UIColor qmui_colorWithHexString:@"#202020"];                                              // NavBarTintColor : QMUINavigationController.navigationBar 的 tintColor，也即导航栏上面的按钮颜色，由于 tintColor 不支持 appearance，所以这里只支持 QMUINavigationController
    QMUICMI.navBarTitleColor = [UIColor qmui_colorWithHexString:@"#202020"];                                             // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
